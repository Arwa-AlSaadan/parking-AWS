...
function Signin() {
  ...
  <div className="w-full h-[100vh] flex justify-center items-center bg-[#e5e5e645]">
    ...
    <div className="w-[70%] h-[80vh] flex bg-gradient-to-b from-[#d9d9d90f] via-[#2d61e310] to-[#d9d9d90f] rounded-2xl border-[1px] shadow-md border-[#d1d1d1] max-sm:justify-center ">
